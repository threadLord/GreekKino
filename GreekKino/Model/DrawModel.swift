...
struct DrawModel: Codable {
    ...
    enum CodingKeys: String, CodingKey {
        case gameID = "gameId"
        case drawID = "drawId"
        case drawTime, status, drawBreak, visualDraw, pricePoints, prizeCategories, wagerStatistics, winningNumbers
    }
}
...
enum AddOnGameType: String, Codable {
    case kenoCloseToWin = "KenoCloseToWin"
...
typealias DrawModelArray = [DrawModel]
